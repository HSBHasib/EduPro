...
export function LoginContent() {
  ...
  const { callbackUrl, getRegisterUrl, getPostAuthRedirect } = useCallbackUrl();
    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-20">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Sign in to continue your learning journey</p>
        </div>
        <Card>
          <CardContent className="p-6">
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm"><span className="bg-white px-3 text-gray-400 dark:bg-dark-800 dark:text-gray-500">or sign in with email</span></div>
            </div>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input {...register("password")} type={showPassword ? "text" : "password"} placeholder="Enter your password" className="flex h-10 w-full rounded-xl border border-gray-200 bg-white px-4 py-2 pr-10 text-sm text-gray-900 placeholder:text-gray-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-300 focus-visible:ring-offset-2 dark:border-dark-600 dark:bg-dark-800 dark:text-white dark:placeholder:text-gray-500" />
        ...
        <p className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
          ...
          <Link href={getRegisterUrl(callbackUrl)} className="font-medium text-brand-400 hover:text-brand-500">Create one</Link>
        </p>
      </div>
    </div>
  );
